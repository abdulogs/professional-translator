                ...
                if(data.count != 0){
                    ...
                    data.results.forEach(item => {
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-break" data-label="Question">${title(item.question)}</td>
                            <td class="align-middle text-break" data-label="Answer">${title(item.answer)}</td>
                            <td class="align-middle text-break" data-label="Status">${active(item.is_active)}</td>
                            <td class="align-middle text-break" data-label="Created by">${createdby(item.created_by)}</td>
                            <td class="align-middle text-wrap" data-label="Created at">${time(item.created_at)}</td>
