                ...
                if(data.count != 0){
                    ...
                    data.results.forEach(item => {
                        ...
                        <tr>
                            ...
                            <td class="align-middle px-4" data-label="Image">${image(item.image)}</td>
                            <td class="align-middle text-break" data-label="Name">${title(item.name)}</td>
                            <td class="align-middle text-break" data-label="Category">${available(item.category, 'name')}</td>
